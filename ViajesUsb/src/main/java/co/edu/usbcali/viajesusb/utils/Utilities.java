...
public class Utilities {
	...
	public static boolean isNullString(String chain) {
	 ...
	 * @author Camilo AndrÃ©s Cifuentes Grass
	 * @version 2018/01/17
	 * @param sEmail el email a verificar
	 * @return true si es un email vÃ¡lido, false en caso que no sea asÃ­.
	 */
	...
	/**
	 * FunciÃ³n para obtener el nÃºmero que sea mÃºltiplo de "multiploDe"
